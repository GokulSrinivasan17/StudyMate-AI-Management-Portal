...
export const StudentLayout = () => {
  ...
  const studentNavItems = [
    ...
    { label: 'Exams', path: '/student/exams', icon: Award },
    { label: 'Results', path: '/student/results', icon: BarChart2 },
    { label: 'My Progress', path: '/student/progress', icon: TrendingUp },
    { label: 'AI Recommendations', path: '/student/ai-recommendations', icon: Sparkles, badge: 'AI' },
    { label: 'AI Assistant', path: '/student/assistant', icon: Bot, badge: 'Chat' },
    { label: 'Reports', path: '/student/reports', icon: FileSpreadsheet },
  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-50 text-slate-900 font-sans">
      <div className="flex flex-1 relative">
        ...
        <aside className="hidden lg:flex flex-col w-64 bg-slate-900 text-slate-300 border-r border-slate-800 p-4 shrink-0 shadow-xl">
          <div className="flex items-center gap-2.5 px-3 py-3.5 mb-4 text-white font-extrabold text-lg border-b border-slate-800">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[10px] font-semibold text-indigo-400 uppercase tracking-wider">Student Portal</span>
            </div>
          </div>
        ...
        {mobileOpen && (
          <div
            className="lg:hidden fixed inset-0 z-50 bg-slate-900/60 backdrop-blur-xs"
            ...
            {studentNavItems.map(item => {
              ...
              return (
                <NavLink
                  ...
                  className={({ isActive }) =>
                    `flex items-center justify-between px-3.5 py-2.5 rounded-xl font-semibold transition-all ${
                      isActive ? 'bg-indigo-600 text-white font-bold' : 'hover:bg-slate-800 text-slate-400'
                    }`
                  }
                >
                  <div className="flex items-center gap-3">
        ...
        <div className="flex-1 flex flex-col min-w-0">
          {/* Authenticated Header (No persona switcher!) */}
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3 pl-3 border-l border-slate-200">
                ...
                <div className="hidden sm:block text-xs text-left">
                  <p className="font-bold text-slate-900 leading-tight">{user?.name || "Harish Kolanjiyappan"}</p>

...
export const TeacherLayout = () => {
  ...
  const teacherNavItems = [
    ...
    { label: 'Exams & Marks', path: '/teacher/exams', icon: Award },
    { label: 'AI Insights', path: '/teacher/ai-insights', icon: Sparkles, badge: 'AI' },
    { label: 'Reports', path: '/teacher/reports', icon: FileSpreadsheet },
      ...
      <div className="flex flex-1 relative">
        ...
        <aside className="hidden lg:flex flex-col w-64 bg-slate-900 text-slate-300 border-r border-slate-800 p-4 shrink-0 shadow-xl">
          <div className="flex items-center gap-2.5 px-3 py-3.5 mb-4 text-white font-extrabold text-lg border-b border-slate-800">
            <div className="p-2 bg-purple-600 rounded-xl text-white shadow-md">
              <GraduationCap className="w-5 h-5" />
            </div>
            <div className="flex flex-col">
              <span className="leading-tight">SmartEdu AI</span>
              <span className="text-[10px] font-semibold text-purple-400 uppercase tracking-wider">Faculty Portal</span>
            </div>
          </div>
            ...
            {teacherNavItems.map(item => {
              ...
              return (
                <NavLink
                  ...
                  className={({ isActive }) =>
                    `flex items-center justify-between px-3.5 py-2.5 rounded-xl font-semibold transition-all ${
                      isActive ? 'bg-purple-600 text-white font-bold' : 'hover:bg-slate-800 text-slate-400'
                    }`
                  }
                >
                  <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3 pl-3 border-l border-slate-200">
                ...
                <div className="hidden sm:block text-xs text-left">
                  <p className="font-bold text-slate-900 leading-tight">{user?.name || "Dr. Aris"}</p>
